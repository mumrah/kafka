...
import kafka.server.DelayedShareFetch;
...
public class ReplicaManagerBuilder {
    ...
    public ReplicaManagerBuilder setDelayedShareFetchPurgatory(DelayedOperationPurgatory<DelayedShareFetch> delayedShareFetchPurgatory) {
        this.delayedShareFetchPurgatory = Optional.of(delayedShareFetchPurgatory);
        return this;
    }
