...
class ReplicaScaleTest(Test):
    ...
    def test_100k_bench(self):
        produce_spec = ProduceBenchWorkloadSpec(0, TaskSpec.MAX_DURATION_MS,
                                                ...
                                                admin_client_conf={},
                                                common_client_conf={},
                                                inactive_topics={"100k_replicas_bench[10-14]": {"numPartitions": 34, "replicationFactor": 3}},
                                                active_topics={"100k_replicas_bench[0-4]": {"numPartitions": 34, "replicationFactor": 3}})
        ...
        consume_spec = ConsumeBenchWorkloadSpec(0, TaskSpec.MAX_DURATION_MS,
                                                ...
                                                admin_client_conf={},
                                                common_client_conf={},
                                                active_topics=["100k_replicas_bench[0-4]"])
